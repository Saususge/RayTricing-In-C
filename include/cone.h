...
/*   Updated: 2025/07/07 17:43:28 by chakim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			cone_lateral_intersect(const t_object *obj, \
	const t_ray *ray, float *t, t_interval t_bound);
int			cone_intersect_cap(const t_object *obj, \
	const t_ray *ray, float *t, t_interval t_bound);
